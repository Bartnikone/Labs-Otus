...
Хотелось бы отметить также момент подвисания соседства в exchange, если MTU на интерфейсах не совпадает, убрал MTU 9214 с Leaf_2 в сторону Spine_1:
...
Затем проверим доступность Lo0 leaf_1 с Leaf_3:
```bash
Leaf-3#ping 10.1.1.11 source 10.1.1.13

PING 10.1.1.11 (10.1.1.11) from 10.1.1.13 : 72(100) bytes of data.

80 bytes from 10.1.1.11: icmp_seq=1 ttl=63 time=28.6 ms

80 bytes from 10.1.1.11: icmp_seq=2 ttl=63 time=21.9 ms

80 bytes from 10.1.1.11: icmp_seq=3 ttl=63 time=16.4 ms

80 bytes from 10.1.1.11: icmp_seq=4 ttl=63 time=14.9 ms

80 bytes from 10.1.1.11: icmp_seq=5 ttl=63 time=17.7 ms
